//
//  ViewThuongDungChuyenTienDenTaiKhoanRutTien.m
//  ViViMASS
//
...
@interface ViewThuongDungChuyenTienDenTaiKhoanRutTien () <UITextFieldDelegate>
{
...
@implementation ViewThuongDungChuyenTienDenTaiKhoanRutTien
{
...
- (DucNT_TaiKhoanThuongDungObject*)getTaiKhoanThuongDungDayLenServer
{
    ...
    if([self validateShowError:NO])
    {
        ...
        taiKhoanThuongDung.nType = TAI_KHOAN_NGAN_HANG_RUT_TIEN;
...
{
//    [self.mtfSoTien setPlaceholder:[@"so_tien_dong" localizableString]];
...
//        [self.mtfTinhThanhPho becomeFirstResponder];
        ...
        __block ViewThuongDungChuyenTienDenTaiKhoanRutTien *blockSELF = self;
...
//    {
//        [bank_ids addObject:[dic_bank_id valueForKey:@"bank_id"]];
...
//        NSString *sTenNganHang = [NSString stringWithFormat:@"%@ - %@", [stringComponent objectAtIndex:0], bank.bank_name];
    ...
    NSString *sTempSoThe = [self.mtfSoTaiKhoan.text stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];

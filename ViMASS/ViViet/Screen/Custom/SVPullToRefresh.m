...
- (void)setPullToRefreshActionHandler:(void (^)(void))actionHandler {
    ...
    titleLabel.text = AMLocalizedString(@"Pull to refresh...",nil);
...
- (void)setLastUpdatedDate:(NSDate *)newLastUpdatedDate {
    self.dateLabel.text = [NSString stringWithFormat:@"%@%@",AMLocalizedString(@"Last Updated: ",nil), newLastUpdatedDate?[self.dateFormatter stringFromDate:newLastUpdatedDate]:NSLocalizedString(@"Never",nil)];
}

- (void)setDateFormatter:(NSDateFormatter *)newDateFormatter {
	dateFormatter = newDateFormatter;
    self.dateLabel.text = [NSString stringWithFormat:@"%@%@",AMLocalizedString(@"Last Updated: ",nil), self.lastUpdatedDate?[newDateFormatter stringFromDate:self.lastUpdatedDate]:NSLocalizedString(@"Never",nil)];
}
...
- (void)startAnimating{
    ...
    titleLabel.text = AMLocalizedString(@"Loading...",nil);
...
- (void)setState:(SVPullToRefreshState)newState {
    ...
    if(pullToRefreshActionHandler && !self.showsPullToRefresh && !self.activityIndicatorView.isAnimating) {
        titleLabel.text = AMLocalizedString(@"",nil);
    ...
    if(pullToRefreshActionHandler) {
        switch (newState) {
            ...
            case SVPullToRefreshStateTriggered:
                titleLabel.text = AMLocalizedString(@"Release to refresh...",nil);

...
- (void)xuLyThucHienKhiKiemTraThanhCongTraVeToken:(NSString *)sToken otp:(NSString *)sOtp {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSDictionary *dictToken = @{
                                    ...
                                    @"level":[NSNumber numberWithInt:level1],
        ...
        NSDictionary *dictMPKI = @{
                                   ...
                                   @"user":[DucNT_LuuRMS layThongTinDangNhap:KEY_LOGIN_ID_TEMP],
                                   @"level":[NSNumber numberWithInt:level2],
        ...
        NSDictionary *dicPost = @{
                                  ...
                                  @"dsHanMuc":arrDict,
                                  @"idOwner":[DucNT_LuuRMS layThongTinDangNhap:KEY_LOGIN_ID_TEMP]
                                  };
